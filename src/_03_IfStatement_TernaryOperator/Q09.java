...
public class Q09 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        if (sayi%5==0&&sayi%8==0) { System.out.println("able to divide by 5 and 8");
			
		} 
        
        if (sayi%10==5&&sayi%9==0) { System.out.println("able to divide by 9 and divide by 10 reminder is 5");
